      ...
      <b-tabs card>
        ...
        <b-tab title="Landing Page">
         <b-container>
          ...
          <card-item :cardTitle="'Card Title'" :cardIcon="'folder2-open'" :iconColor="'purple'" :buttonIcon="'arrow-right'" :btnLink="'/home'">Description goes Here: Sed sed felis posuere, tempor ipsum at, lacinia tortor, mauris mattis, mauris non pretium sodales</card-item>
